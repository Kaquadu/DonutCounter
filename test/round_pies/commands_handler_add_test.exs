defmodule Donuts.Slack.CommandsHandlerUnitTest do
  ...
  describe "Functions necessary to add a donut" do
    test "process_adding_donut - valid data" do
      ...
      result = CommandsHandler.process_adding_donut(user1.slack_name, user2.slack_id, "general")

      expected_message =
        "Mmmmm... <@#{user2.slack_name}> just owes us some donuts thanks to <@#{user1.slack_name}>'s vigilance"
        |> URI.encode()
    ...
    test "process_adding_donut - self sending" do
      ...
      result = CommandsHandler.process_adding_donut(user1.slack_name, user1.slack_id, "general")

      expected_message =
        message =
        "Self sending is forbidden. Do you wanna owe donuts to everyone..?"
        |> URI.encode()
    ...
    test "process_adding_donut - wrong username" do
      ...
      result = CommandsHandler.process_adding_donut("@asdf", user2.slack_id, "general")

      expected_message =
        message =
        "I'm sorry, it seems you picked a wrong username :("
        |> URI.encode()
    ...
    test "initialize_donut - valid data" do
      ...
      result = CommandsHandler.initialize_donut(user1, user2.slack_id, "general")
    ...
    test "initialize_donut - sender invalid" do
      ...
      result = CommandsHandler.initialize_donut(nil, user2.slack_id, "general")
    ...
    test "add_donut - valid data" do
      ...
      message =
        "Mmmmm... <@#{user1.slack_name}> just owes us some donuts thanks to <@#{user2.slack_name}>'s vigilance"
        |> URI.encode()
    ...
    test "add_donut - self sending" do
      ...
      message =
        "Self sending is forbidden. Do you wanna owe donuts to everyone..?" |> URI.encode()
