...
<<<<<<< HEAD
      List of commands: \n
      _/donuts @your-name_ - add donut debt to the currently logged person. Remember to sign yourself with @your_name - we all would like to know to whom we owe delicious donuts :wink: \n
      _/donuts release @name-of-guilty_ - releases the odlest debt of @name_of_guilty marking it as delivered \n
      _/donuts remove @name-of-guilty_ - removes the newest debt of of @name_of_guildy and removes it from statistics, used in case of mistakes \n
