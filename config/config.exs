...
config :donuts,
  ...
  redirect_uri_auth: "http://plebs.serveo.net/auth",
  redirect_uri_loggedin: "http://plebs.serveo.net/loggedin",
  verification_token: "d77fq65TdeT0hvpraviVUpnE",
  oauth_token: "xoxp-632634181587-644044063701-649586418432-f5dedc8b53ea9a56ea97ed9e35f42a2b",
  ttl_seconds: 1800,
